...
for i in continu :
    ...
    continu1 = [0,1]
    for j in continu1  : # nombre_arme_a > 0 and nombre_arme_d > 0 :
        continu2 = [0]
        for k in continu2 :  #while True :
            try :
        ...
        if not (nombre_arme_a > 0 and nombre_arme_d > 0) :
            break
        ...
        if nombre_arme_a > 0 and nombre_arme_d > 0 :
            continu1.append(1)
