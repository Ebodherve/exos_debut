...
class Wagon(object):
    def __init__(self, canev, x, y,couleur = "orange"):
    ...
    def perso(self, fen):
        ...
        yf = self.y + 25
        cercle(self.canev, xf, yf, 10,color= "")        # visage
        cercle(self.canev, xf-5, yf-3, 2,color= "")        # oeil gauche
        cercle(self.canev, xf+5, yf-3, 2,color= "")        # oeil droit
        cercle(self.canev, xf, yf+5, 3,color= "")        # bouche
    def allumer(self):
