class Application(object):
    ...
    def changeCouleurs(self,event):
        ...
        if err ==1 or v<1 or v > 1e11 :
            self.can.itemconfigure(self.ligne[0], fill ="black")    # entrée incorrecte ou hors limites
            self.can.itemconfigure(self.ligne[1], fill ="black")
            self.can.itemconfigure(self.ligne[2], fill ="black")
        elif 1 < v < 10 :
            i = int(v/10)
