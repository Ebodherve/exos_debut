...
class OscilloGraphe(Canvas):
    ...
    def __init__(self, boss =None, larg=200, haut=150):
        ...
        for t in range(1, 9):
            ...
            self.create_line(stx, 0, stx, haut, fill="grey")
            self.create_line(10, stx-4, larg, stx-4, fill="grey")
        #positonnement des texts de d'abcisse et ordonnée
        self.create_text(20,10,text="e")
        self.create_text(larg-10,haut/2-10,text = "t")
