...
def move():
    ...
    if x1 >210 and y1 >210:
        x1, y1, dx, dy = 210, 210, 0, -15
    elif x1 <10 and y1 >210:
        x1,y1, dx, dy = 10,210, 0, -15
    elif y1 <10 and x1 <15:
        x1, y1, dx, dy = 10, 10, 15, 15
    elif y1 <10 and x1 >200:
        x1,y1, dx, dy = 210, 10, -15, 15
    else :
        pass
